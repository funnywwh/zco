...
pub const StreamingRequest = struct {
    ...
    headers: std.ArrayList(struct { name: []u8, value: []u8 }),
    ...
    pub fn init(allocator: std.mem.Allocator) Self {
        return .{
            ...
            .header_buf = HeaderBuffer.init(),
            .headers = std.ArrayList(struct { name: []u8, value: []u8 }).init(allocator),
        };
    }
                ...
                .on_body_chunk => |chunk| {
                    if (self.body_handler) |bh| {
                        switch (bh) {
                            ...
                            .write_file => |file| { _ = try file.write(chunk); },
